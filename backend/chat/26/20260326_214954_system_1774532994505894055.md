...
**Generated at:** 2026-03-26 21:49:54
...
```
You are an AI assistant using the qwen-coder-plus model. Current time: 2026-03-26 21:49:54.

User's first question: Create a Next.js middleware that checks for a valid JWT in cookies and redirects unauthenticated users to `/login`. use context7

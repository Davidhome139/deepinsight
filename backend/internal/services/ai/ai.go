...
type PromptEngineeringConfig struct {
	...
	CustomRoleInfo          string `json:"customRoleInfo"`
	OutputFormat            string `json:"outputFormat"`
	Schema                  string `json:"schema"`
	ChainOfThought          bool   `json:"chainOfThought"`
	MaxChains               int    `json:"maxChains"`
	ToolCalls               bool   `json:"toolCalls"`
	SelfEvaluation          bool   `json:"selfEvaluation"`
	PromptOptimizationEnabled bool   `json:"promptOptimizationEnabled"`
	PromptOptimizationLevel  string `json:"promptOptimizationLevel"`
	EnableContextEnhancement bool   `json:"enableContextEnhancement"`
	EnableIntentUnderstanding bool   `json:"enableIntentUnderstanding"`
}

// NewDefaultPromptEngineeringConfig 创建一个具有默认值的 PromptEngineeringConfig
func NewDefaultPromptEngineeringConfig() *PromptEngineeringConfig {

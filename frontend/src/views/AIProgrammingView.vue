  ...
  <div class="ai-programming-layout">
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-brand">
        ...
        <span class="brand-text">{{ t('aiProgramming.aiCode') }}</span>
      </div>

      <!-- Navigation Icons -->
      <nav class="sidebar-nav">
        <el-tooltip :content="t('aiProgramming.chat')" placement="right">
          <div class="nav-item" @click="$router.push('/')">
            <el-icon :size="20"><ChatDotRound /></el-icon>
          </div>
        </el-tooltip>
        <el-tooltip :content="t('aiProgramming.aiAiChat')" placement="right">
          <div class="nav-item" @click="$router.push('/ai-chat')">
            <el-icon :size="20"><Connection /></el-icon>
          </div>
        </el-tooltip>
        <el-tooltip :content="t('aiProgramming.video')" placement="right">
      ...
      <div class="sidebar-bottom">
        <ThemeToggle />
        <el-tooltip :content="t('aiProgramming.settings')" placement="right">
          <div class="nav-item" @click="showAgentEditor = true">
            <el-icon :size="20"><Setting /></el-icon>
          </div>
        </el-tooltip>
        <el-tooltip :content="t('aiProgramming.enhancedFeatures')" placement="right">
    ...
    <aside class="control-panel">
      ...
      <div class="task-card">
        <div class="task-header">
          ...
          <span>{{ t('aiProgramming.taskDescription') }}</span>
        </div>
        <el-input
          v-model="taskDescription"
          type="textarea"
          :rows="4"
          :placeholder="t('aiProgramming.taskPlaceholder')"
          resize="none"
          class="task-input"
        />
        <div class="task-actions">
          <el-select v-model="selectedModel" size="small" class="model-select" @change="onModelChange">
            <el-option-group :label="t('aiProgramming.deepseek')">
              <el-option :label="t('aiProgramming.reasoner')" value="deepseek-reasoner" />
              <el-option label="Chat" value="deepseek-chat" />
            </el-option-group>
            <el-option-group :label="t('aiProgramming.hunyuan')">
              <el-option :label="t('aiProgramming.lite')" value="hunyuan-lite" />
              <el-option :label="t('aiProgramming.standard')" value="hunyuan-standard" />
            </el-option-group>
            <el-option-group :label="t('aiProgramming.qwen')">
              <el-option :label="t('aiProgramming.max')" value="qwen-max" />
              <el-option :label="t('aiProgramming.plus')" value="qwen-plus" />
            </el-option-group>
          </el-select>
          <el-button 
            v-if="!isProcessing"
      ...
      <div class="section" v-if="activeAgents.length > 0">
        <div class="section-header">
          ...
          <span>{{ t('aiProgramming.activeAgents') }}</span>
      ...
      <div class="section log-section">
        <div class="section-header">
          ...
          <span>{{ t('aiProgramming.activity') }}</span>
      ...
      <div class="section tools-section">
        <div class="section-header">
          ...
          <span>{{ t('aiProgramming.tools') }}</span>
        </div>
    ...
    <main class="workspace">
      ...
      <header class="workspace-header">
        ...
        <div class="header-right">
          <div class="status-indicator" :class="{ processing: isProcessing }">
            ...
            <span>{{ isProcessing ? 'Running' : t('aiProgramming.ready') }}</span>
          </div>
        </div>
      </header>
      ...
      <div class="editor-area">
        ...
        <aside class="file-explorer" v-show="showFileExplorer">
          <div class="explorer-header">{{ t('aiProgramming.explorer') }}</div>
          <el-tree
            :data="fileTree"
      ...
      <div class="terminal-area" :style="{ height: terminalHeight + 'px' }">
        <div class="terminal-header" @mousedown="startResize">
          <div class="terminal-title">
            ...
            <span>{{ t('aiProgramming.terminal') }}</span>
          </div>
    ...
    <el-dialog
      ...
      :title="t('aiProgramming.agentConfiguration')"
      width="70%"
      ...
      <el-tabs v-model="activeAgentTab" type="border-card">
        ...
        >
          <el-input
            ...
            type="textarea"
            :rows="18"
            :placeholder="t('aiProgramming.agentPromptPlaceholder')"
          />
        </el-tab-pane>
      </el-tabs>
      <template #footer>
        <el-button @click="showAgentEditor = false">{{ t('common.cancel') }}</el-button>
    ...
    <el-drawer
      ...
      :title="t('aiProgramming.enhancedFeaturesTitle')"
      direction="rtl"
      size="480px"
    ...
    <el-drawer
      v-model="showResults"
      :title="t('aiProgramming.taskResults')"
      direction="rtl"
      size="500px"
      v-if="taskResults"
    >

      ...
      <section class="gallery-panel">
        <div class="gallery-header">
          ...
          <div class="header-actions">
            <el-button @click="loadHistory" :icon="Refresh" circle :title="t('common.refresh')" />
        ...
        <div v-else-if="history.length === 0" class="empty-state">
          ...
          <span>{{ t('common.test') }} your first image to see it here</span>
        </div>
            ...
            <div class="image-thumbnail">
              ...
              <div class="image-overlay">
                <div class="overlay-actions">
                  <el-button circle size="small" @click.stop="downloadImage(img)" :title="t('common.download')">
                    <el-icon><Download /></el-icon>
                  </el-button>
                  <el-button circle size="small" type="danger" @click.stop="deleteImage(img.id)" :title="t('common.delete')">

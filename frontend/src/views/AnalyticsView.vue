<template>
  <div class="analytics-view">
    <div class="header">
      <h1>{{ t('analytics.usageAnalytics') }}</h1>
    ...
    <div v-if="loading" class="loading">{{ t('analytics.loadingAnalyticsData') }}</div>
    ...
    <div v-else class="analytics-content">
      ...
      <div class="summary-cards">
        <div class="card">
          ...
          <div class="card-content">
            <h3>{{ t('analytics.totalRequests') }}</h3>
        ...
        <div class="card">
          <div class="card-icon">⚡</div>
          <div class="card-content">
            <h3>{{ t('analytics.avgResponseTime') }}</h3>
            ...
            <div v-for="(day, index) in dailyUsage" :key="index" class="bar-group">
              <div class="bar-wrapper">
                <div 
                  ...
                  :title="`${day.requests} ${t('analytics.requests')}`"
                ></div>
              </div>
      ...
      <div class="breakdown-section">
        <h2>{{ t('analytics.costBreakdownByService') }}</h2>
      ...
      <div class="charts-row">
        ...
        <div class="chart-card">
          <h2>{{ t('analytics.modelUsageDistribution') }}</h2>
        ...
        <div class="chart-card">
          <h2>{{ t('analytics.responseTimeDistribution') }}</h2>
          <div class="histogram">
      ...
      <!-- Token Usage Trend -->
      <div class="chart-section">
        <h2>{{ t('analytics.tokenUsageTrend') }}</h2>
        <div class="trend-chart">
          ...
          <div class="trend-legend">
            <span class="trend-item"><span class="trend-dot input"></span> {{ t('analytics.inputTokens') }}</span>
            <span class="trend-item"><span class="trend-dot output"></span> {{ t('analytics.outputTokens') }}</span>
          </div>
        </div>
      </div>
          ...
          <div v-for="item in recentUsage" :key="item.id" class="recent-item">
            ...
            <div class="recent-content">
              ...
              <div class="recent-details">
                <span>{{ item.input_tokens + item.output_tokens }} {{ t('analytics.tokens') }}</span>
                <span>${{ item.cost.toFixed(6) }}</span>
                <span>{{ formatTime(item.created_at) }}</span>
              </div>
            </div>
          </div>
          <div v-if="recentUsage.length === 0" class="no-data">{{ t('analytics.noRecentActivity') }}</div>
        </div>
      </div>
    </div>
  </div>
